    ...
    <div className='container'>
        ...
        <div className='row g-0 justify-content-around'>
            ...
            <div className='col-12 col-lg-9'>
                <div className='bg-banner-img text-light' data-aos="fade-left">
                    <h1 className='p-5 '>VR Gaming with friend</h1>
                    <p className='px-5 '>WEEKEND SALE</p>
                    <p className='h1 px-5'>20 % OFF</p>
                </div>
                <Product/>
            </div>
        </div>
